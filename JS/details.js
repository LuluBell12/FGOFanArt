...
const infoData = [
  ...
  { mainTitle: 'III<br>皇后The Empress', subTitle: 'Larva/提亞馬特', message: 'ILLUST:夜貓<br>FB:<a href="https://example.com" target="_blank">臉書名</a>' },
  ...
  { mainTitle: 'VII<br>戰車The Chariot', subTitle: '阿基里斯', message: 'ILLUST:竹籤<br>FB:<a href="https://example.com" target="_blank">臉書名</a>' },
  ...
  { mainTitle: 'XI<br>正義The Justice', subTitle: '沖田總司', message: 'ILLUST:夜貓<br>FB:<a href="https://example.com" target="_blank">臉書名</a>' },
  ...
  { mainTitle: 'Knight of Swords', subTitle: '庫‧夫林', message: 'ILLUST:竹籤<br>FB:<a href="https://example.com" target="_blank">臉書名</a>' },
